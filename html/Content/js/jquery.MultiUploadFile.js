...
;if (window.jQuery) (function ($) {
    ...
    $.fn.MultiFile = function (options) {
        ...
        options || {},
         ...
         b = $('<a class="MultiFile-remove" href="#' + MultiFile.wrapID + '"><img src="/Content/images/icon_delete.png" alt="" />' + MultiFile.STRING.remove + '</a>');
    ...
    */
    $.fn.MultiFile.options = { //$.extend($.fn.MultiFile, { options: {
        ...
        STRING: {
            remove: '',
            denied: 'Bạn không thể chọn $ext file.\nVui lòng chọn lại...',
            file: '$file',
            selected: 'File selected: $file',
            duplicate: 'Hình ảnh $file đã được chọn.\nVui lòng chọn hình khác...'
        },
