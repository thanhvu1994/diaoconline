<div id="content_container">
    <div class="wrap">
        <div id="register" class="margin_bottom box_bold_border">
            ...
            <div class="body">
                <div class="left">
                    <form action="#" method="post" class="form_style_3">
                                ...
                                <fieldset>
                                    <ul>
                                        <li>
                                            ...
                                            <input required id="UserName" maxlength="30" name="Users[username]" type="text" value="" />
                                        </li>
                                        <li>
                                            <label for="Password">Mật khẩu</label>
                                            <span class="hightlight">*</span>
                                            <input required id="Password" maxlength="30" name="Users[password]" type="password" value="" />
                                        </li>
                                        <li>
                                            <label for="ConfirmPassword">X&#225;c nhận mật khẩu</label>
                                            <span class="hightlight">*</span>
                                            <input required id="ConfirmPassword" maxlength="30" name="Users[confirm_password]" type="password" value="" />
                                        </li>
                                        <li>
                                            <label for="Email">Email</label>
                                            <span class="hightlight">*</span>
                                            <input required id="Email" maxlength="150" name="Users[email]" type="text" value="" />
                                        </li>
                                    </ul>
                                </fieldset>
                            </div>
                                ...
                                <fieldset>
                                    <ul>
                                        <li><label for="FullName">Họ v&#224; T&#234;n</label> <span class="hightlight">*</span>
                                            <input id="FullName" maxlength="150" name="Users[full_name]" type="text" value="" /></li>
                                        <li><label for="BirthDay">Ng&#224;y sinh</label>
                                            <div class="dob">
                                                <select id="AllDay" name="Users[birth_day]"><option selected="selected" value="-1">Chọn ng&#224;y</option>
                                                ...
                                                <select id="AllMonth" name="Users[birth_month]"><option selected="selected" value="-1">Chọn th&#225;ng</option>
                                                    <option value="1">1</option>
                                                    <option value="2">2</option>
                                                    <option value="3">3</option>
                                                    <option value="4">4</option>
                                                ...
                                                <select id="AllYear" name="Users[birth_year]"><option selected="selected" value="-1">Chọn năm</option>
                                        ...
                                        <li><label for="Gender">Giới t&#237;nh</label>
                                            <div class="gender">
                                                <input checked="checked" id="MenGender" name="Users[gender]" type="radio" value="Nam" /><label for="MenGender">Nam</label>
                                                <input id="WomenGender" name="Users[gender]" type="radio" value="Nu" /><label for="WomenGender">Nữ</label></div>
                                        </li>
                                            ...
                                            <div class="dob" id="city">
                                                ...
                                                <select id="selectCity" name="Users[city]">
                                                    ...
                                                    <?php foreach($cities as $value => $city): ?>
                                                        <option value="<?php echo $value; ?>"><?php echo $city['name']; ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                        ...
                                        <li><label for="Mobile1">Điện thoại</label>
                                            <div class="tel"><input required id="Mobile1" maxlength="10" name="Users[phone_number]" placeholder="Điện thoại bàn" type="text" value="" />
                                                <input id="Mobile2" maxlength="30" name="Users[mobile_number]" placeholder="Di động" type="text" value="" /> <span class="hightlight">*</span></div>
                                        </li>
                                        <li><label for="CompanyName">T&#234;n c&#244;ng ty</label>
                                            <input id="CompanyName" maxlength="200" name="Users[company]" type="text" value="" /></li>
                                        <li><label for="Website">Website</label>
                                            <input id="Website" maxlength="200" name="Users[website]" type="text" value="" /></li>
                                    </ul>
                                </fieldset>
                            </div>
                        </div>
                        <div class="rounded_style_2 rounded_box">
                            <div class="body">
                                <fieldset>
                                    <ul>
                                        <li class="disclaimer"><input type="checkbox" name="rule" id="rule" required/><label for="rule">Tôi hoàn toàn đồng ý với <a href="http://www.diaoconline.vn/dieu-khoan-thoa-thuan" target="_blank"><strong>các điều khoản thỏa thuận</strong></a></label></li>
                                        <li class="btn">
