<div class="row bg-title">
    ...
    <?php
        $breadcrumb = [base_url('admin/system') => 'Dashboard', base_url('admin/'.$this->router->fetch_class()) => 'Quản lý đường trước nhà', 'active' => $title];
        ...
        <div class="white-box">
            ...
            <?php echo form_open_multipart($link_submit, ['class' => 'form-horizontal']); ?>
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <input type="text" class="form-control" value="<?php echo (isset($model)) ? $model['name'] : ''?>" name="FrontArea[name]" required>
                    </div>
                </div>
