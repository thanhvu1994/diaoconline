<div class="row bg-title">
    ...
    <?php
        $breadcrumb = [base_url('admin/system') => 'Dashboard', base_url('admin/'.$this->router->fetch_class()) => 'Quản lý hướng nhà', 'active' => $title];
        ...
        <div class="white-box">
            ...
            <?php echo form_open_multipart($link_submit, ['class' => 'form-horizontal']); ?>
                <div class="form-group">
                    <label class="col-md-12">Hướng nhà</label>
                    <div class="col-md-12">
                        <input type="text" class="form-control" value="<?php echo (isset($model)) ? $model['name'] : ''?>" name="Direction[name]" required>
                    </div>
                </div>
