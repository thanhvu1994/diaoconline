...
<head>
    ...
    <script src="<?php echo base_url('themes/website/js/js.cookie.js')?>" type="text/javascript"></script>
    <link href="<?php echo base_url('themes/website/css/fix_user.css')?>" rel="stylesheet" type="text/css" />
</head>