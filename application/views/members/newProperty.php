                                                ...
                                                <!--<li class="map">
                                                    ...
                                                    <div id="IdMap">
                                                        ...
                                                        <script type="text/javascript">
                                                            ...
                                                            function initialize() {
                                                                if ($('#MapX') && $('#MapX').val() != "") {
                                                                    myLatlng = new google.maps.LatLng($('#MapX').val(), $('#MapY').val());
                                                                } else {
                                                            ...
                                                            function loadScript() {
                                                                ...
                                                                script.type = "text/javascript";
                                                                script.src = "http://maps.googleapis.com/maps/api/js?key=" + keyGmap + "&callback=initialize";
                                        ...
                                        <fieldset>
                                            <ul>
                                                ...
                                                <li>
                                                    ...
                                                    <a name="SubmitCancel" class="btn_3" href="<?php echo base_url('tai-khoan-cua-toi.html'); ?>"><span>HỦY BỎ</span></a>
